...
export const SOURCES: Record<string, SourceInfo> = {
  ...
  forest_reserve: {
    label: "Permanent Forest Reserve Area",
    org: "Forestry Department of Peninsular Malaysia / DOSM",
    url: "https://open.dosm.gov.my/data-catalogue/forest_reserve_state",
    geography: "National / State",
    unit: "hectares",
    lastUpdated: "2021",
  },
  water_utilities: {
    label: "Water Consumption & Production",
    org: "National Water Services Commission (SPAN) / DOSM",
    url: "https://open.dosm.gov.my/data-catalogue/water_consumption",
    geography: "State (annual mean of monthly rates)",
    unit: "millions of litres per day (MLD)",
    lastUpdated: "2022",
  },
  air_pollution: {
    label: "Air Pollution",
    org: "Department of Environment (DOE) / DOSM",
    url: "https://open.dosm.gov.my/data-catalogue/air_pollution",
    geography: "National only",
    unit: "ppm or µg/m³ (varies by pollutant)",
    lastUpdated: "2022",
  },
  ghg_emissions: {
    label: "Greenhouse Gas Emissions",
    org: "Ministry of Natural Resources & Environmental Sustainability / DOSM",
    url: "https://open.dosm.gov.my/data-catalogue/ghg_emissions",
    geography: "National only",
    unit: "Gg CO2e",
    lastUpdated: "2021",
  },
  water_pollution: {
    label: "River Basin Pollution Monitoring",
    org: "Department of Environment (DOE)",
    url: "https://open.dosm.gov.my/data-catalogue/water_pollution_basin",
    geography: "National (river-basin monitoring rolled up)",
    unit: "% of monitored basins",
    lastUpdated: "2021",
  },
  electricity_flow: {
    label: "Electricity Consumption & Supply",
    org: "Tenaga Nasional Berhad / Sabah Electricity / Sarawak Energy / Energy Commission / DOSM",
    url: "https://open.dosm.gov.my/data-catalogue/electricity_consumption",
    geography: "National only",
    unit: "millions of kilowatt-hours (MKWh)",
    lastUpdated: "2024 (latest year partial)",
  },
};
