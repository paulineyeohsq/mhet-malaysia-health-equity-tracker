# Validation report: `data/raw/socioeconomic/hh_income_state.csv`

- Rows: **319**
- Columns: `state, date, income_mean, income_median`
...
| state | 319 | 0 | 0.0% |
| date | 319 | 0 | 0.0% |
| income_mean | 319 | 0 | 0.0% |
| income_median | 308 | 11 | 3.4% |
...
|---|---|---|---|
| income_mean | 140.0 | 13985.0 | 0 |
| income_median | 108.0 | 10802.0 | 0 |
